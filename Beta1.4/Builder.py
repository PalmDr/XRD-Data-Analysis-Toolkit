...
def buildFrame(root):
    ...
    sub_2_2_2 = Frame(sub_2_2)
    sub_2_2_2.pack(side=BOTTOM, anchor='s', fill=X)

    sub_2_2_2_1 = Frame(sub_2_2_2)
    sub_2_2_2_1.pack(side=TOP, anchor='n', fill=X)

    sub_2_2_2_2 = Frame(sub_2_2_2)
    sub_2_2_2_2.pack(side=BOTTOM, anchor='n', fill=X)

    return sub_1, sub_2, sub_1_1, sub_1_2, sub_2_1, sub_2_2, sub_2_2_1, sub_2_2_2, sub_2_2_2_1, sub_2_2_2_2
...
def buildDirectoryDisplay(sub_2_2_2_1, sub_2_2_2_2):
    LaB6 = Entry(master=sub_2_2_2_1)
    LaB6.pack(side=LEFT, anchor="w", expand=True, fill='x')

    CSV = Entry(master=sub_2_2_2_2)
    CSV.pack(side=LEFT, anchor="w", expand=True, fill='x')
